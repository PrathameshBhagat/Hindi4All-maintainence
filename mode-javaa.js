    ...
    function r() {
        ...
        this.$rules = {
            ...
            {  //just to offer precedence
                token: "keyword.other",
                regex: /((?<=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))(?:दिनांकऔरसमयस्वरूपण|दिनांकऔरसमय|फाइलबनाए|हैअगलीरेखा)((?=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))/
            },
            {  
                token: "keyword.other",
                regex: /((?<=\s+|^|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))(?:तंत्र|बाहर|कक्षा|सार्वजनिक|सार्वजनीक|स्थिर|सार|अंतरापृष्ठ|निजी|सुरक्षित|इस|विरासेगा|उच्च|लागू|फेके|प्रिंट|रिक्त|जरूरी|समूह|वापस|नई|वर्ग|अंतिम|धागा|चलनेयोग्य|इअंक|दिनांक|समय|स्कैनर|अगलीरेखा|अगलादोहरा|अगलाबाइट|अगलाबड़ा|अगलाफ्लोट|अगलाअंक|अगलालंबा|अगलाछोटा|मान|लंबाई|अभी|मे|चले|शुरू|ज़्यादा|कम|मूल|शुद्ध|अनुक्रमांक|कोई|फाइल|लिखे|बंद|नष्ट|स्वरूप|रूप|अंकगणितत्रुटि|फ़ाइलप्राप्तीमेत्रुति|ट्रामअनुक्रमांकसीमाकेबाहारत्रुति|सुरक्षात्रुटि|त्रुटि)((?=\s+|$|\(|\)|\{|\}|\.|\b|\||\[|:|!|;|,|\]|\?))/
